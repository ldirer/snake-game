...
var Snake = function (x, y, initialSize) {
  /** We store position of every element part of the snake. */
  this.points = [];
...
Snake.prototype.grow = function (n) {
  ...
  // We need to know the direction of the tail to grow it properly.
...
Snake.prototype.move = function (key) {
  ...
  // Add the new head element and remove the last one
...
/* A bonus is an edible that is worth more points but whose value decays over time */
